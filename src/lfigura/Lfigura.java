...
import java.util.*;
import java.lang.String; /* esta la importe yo*/
...
public class Lfigura {
   ...
   enum Figuras {
    ...
    public Lfigura rotar()
    {
        ...
        Lfigura PiezaRotada = new Lfigura();
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            Lfigura l =new Lfigura();
            l.asignarForma(Figuras.Cuadrado);
            l.escogerPiezaAleatoriamente();
    }
